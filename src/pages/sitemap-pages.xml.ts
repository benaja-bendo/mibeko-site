...
const STATIC_PATHS = ['/', '/textes', '/textes/nouveautes', '/guides', '/situations', '/a-propos', '/application', '/professionnels', '/assistant', '/methode', '/contact', '/cgu', '/confidentialite', '/mentions-legales'];
